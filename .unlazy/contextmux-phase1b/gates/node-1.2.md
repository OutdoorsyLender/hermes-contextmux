...
Children: 1.2.1.1, 1.2.1.2, 1.2.2, 1.2.3, 1.2.4

Scope: invocation semantics are measured and the cache decision follows from them

- [ ] G1: every child ledger is reverified, not merely status-read
  CHECK: node scripts/verify-leaf.mjs --branch 1.2 --mode reverify
  EXPECT: branch 1.2 children reverified
  EVIDENCE: pending
