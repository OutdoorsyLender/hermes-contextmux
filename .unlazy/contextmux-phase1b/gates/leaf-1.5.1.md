...
Scope: Proof that Hermes Tool Search still functions normally with the probe installed.

- [ ] G1: Tool Search remains functional with the probe present
  CHECK: node scripts/verify-leaf.mjs --leaf 1.5.1 --mode evidence
  EXPECT: leaf 1.5.1 evidence verified
  EVIDENCE: pending
