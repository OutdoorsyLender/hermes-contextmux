...
Children: 1.3.1, 1.3.2.1, 1.3.2.2, 1.3.3

Scope: prompt-shape claims hold at runtime without disturbing the stable prefix

- [ ] G1: every child ledger is reverified, not merely status-read
  CHECK: node scripts/verify-leaf.mjs --branch 1.3 --mode reverify
  EXPECT: branch 1.3 children reverified
  EVIDENCE: pending
